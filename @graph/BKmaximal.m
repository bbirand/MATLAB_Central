function [ M ] = BKmaximal_M( g )
%BKMAXIMAL Find maximal stable set using Bron-Kerbosch algorithm
%   Given a graph g, calculates the matrix of maximal independent sets
%   using the Bron-Kerbosch algorithm in a recursive manner
%
%   Berk Birand (c) 2009
%   http://www.ee.columbia.edu/~berk/

no_vertices = nv(g);
int_matrix = matrix(g);    %% interference matrix of g
